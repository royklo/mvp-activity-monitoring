...
Source: wheremymvps.at attendance record. 

The Summary field is a JSON object with 'speaker' (userId, userName, status) and 'conference' (name, location, country, startDate, endDate, description, topics, website). 
